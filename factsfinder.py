...
#     print(f"{len(merged_df)} entries from {len(csv_files)} file(s), ranging from {first_date.date()} to {last_date.date()}, have been loaded for analysis.")
...
#                 print(f"Start date cannot be earlier than {first_date.date()}. Please enter a valid start date.")
#                 continue
#             if start_date > last_date:
#                 print(f"Start date cannot be later than {last_date.date()}. Please enter a valid start date.")
#                 continue
#             break
#         except ValueError:
...
#                 print(f"End date cannot be later than {last_date.date()}. Please enter a valid end date.")
#                 continue
#             break
#         except ValueError:
#             print("Invalid date format. Please enter in YYYYMMDD format.")
...
#     merged_df['Date'] = pd.to_datetime(merged_df.iloc[:, 0], errors='coerce')
...
def analyze_data(merged_df, start_date, end_date):
    ...
    # Most frequent behavior per hub
